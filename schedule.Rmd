...
"Chapters 1-3: Overview, Review of Simple Linear Regression, Intro to R
...
#### Fri, Sept 7
  * **In class**, we will work on:
    * Material from: Section 2.2.2 and the part of 3.3.2 titled \"Non-linear Relationships\" of ISLR (to be continued next week)
