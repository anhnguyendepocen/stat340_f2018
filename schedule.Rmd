...
#### Mon, Sep 10
  * **In class**, we will work on:
    * Mean Squared Error and the Bias-Variance Trade-Off.  [pdf](materials/20180910_MSE_Bias_Var_Pairs_Plots/20180910_Example_2_MSE_Bias_Variance.pdf)
 ...
 * **After class**, please:
    ...
    * **Homework**:
        * **Homework 2 due Wednesday, Sept 12**: Data Camp assignment about ggplot2
        * **Homework 3 due Monday, Sept 17**: To be assigned on GitHub by end of day today.

#### Wed, Sep 12
 * **In class**, we will work on:
    * Multiple Linear Regression with quantitative explanatory variables
 * **After class**, please:
    * **Homework**:
        * **Homework 3 due Monday, Sept 17**

#### Fri, Sep 14
 * **In class**, we will work on:
    * Multiple Linear Regression with quantitative and categorical explanatory variables
 * **After class**, please:
    * **Homework**:
        * **Homework 3 due Monday, Sept 17**
"
