...
#### Wed, Sep 26
 * **In class**, we will work on:
    * If necessary, finish non-parametric regression with K nearest neighbors
    * Start thinking about classification for 2 classes via logistic regression
 * **After class**, please:
    * **Homework 4 due Friday, Sept 28**
 ...
 * **In class**, we will work on:
    * Classification for 2 classes via (multiple) logistic regression
 * **After class**, please:
