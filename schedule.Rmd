 ...
 * **In class**, we will work on:
    * Review Quiz (make ups will be allowed)
    * Finish Lab 05
 * **After class**, please:
...
"
Chapter 4, Sections 4.3, 4.4 and 4.6: Multiple Logistic Regression, Multinomial Logistic Regression, and KNN
...
#### Wed, Oct 3
 * **In class**, we will work on:
    * More about multiple logistic regression
 * **After class**, please:
    * **Homework 5 and Homework 6 due Friday, Oct 5**
