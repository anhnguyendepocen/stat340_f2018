...
"
Start on Chapter 8: Pricipal Components Regression? Start on Tree-Based Methods

#### Mon, Oct 29
 * **In class**, we will work on:
    * **Quiz** on material from Chapter 4 (classification).  See quizzes page for topics.
    * Finish Lab 11 or Introduce Principal Components Regression or Introduce Classification and Regression Trees?
...
"
Start on Chapter 7: Splines

**Midterm 2 this week** - take home.
...
"
More on Splines; Thanksgiving Break
