...
#### Mon, Sep 17
 * **In class**, we will work on:
    * Multiple Linear Regression with both quantitative and categorical explanatory variables
    * Lab 03 about multiple linear regression with both quantitative and categorical explanatory variables
 * **After class**, please:
    * **Homework**:
        * **Homework 3 due Wednesday, Sept 19**
 ...
 * **After class**, please:
    * **Read**:
        * Section 3.5 of ISLR
    * **Homework**:
        * **Homework 4 due Wednesday, Sept 26**
