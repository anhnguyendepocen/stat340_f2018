...
"
Chapter 4, Sections 4.3, 4.4 and 4.6: Multiple Logistic Regression and KNN

#### Mon, Oct 1
 * **In class**, we will work on:
    * Overview of HW 4
    * Intro to classification for 2 classes via (multiple) logistic regression
    * Lab 06
 * **After class**, please:
    * **Homework 5 and Homework 6 due Friday, Oct 5**
...
#### Wed, Oct 3
 * **In class**, we will work on:
    * More about multiple logistic regression: categorical explanatory variables, parameter interpretation
...
#### Fri, Oct 5
 * **Homework 5 and Homework 6 due today!**
 * **In class**, we will work on:
    * More about multiple logistic regression or KNN for classification?
 * **After class**, please:
"
  )
```
...
"
Sections 5.1, 6.1, 6.3, and 6.4: Variable Selection Methods; Problems in High Dimensions
